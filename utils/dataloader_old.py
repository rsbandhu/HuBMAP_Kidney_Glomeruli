...
from utils import preprocessing_utils_old as utils

class Dataset_Image_mask(Dataset):

    def __init__(self, data_dir, mean, std_dev):
        super(Dataset_Image_mask, self).__init__()
        self.root_dir = data_dir
        self.transform = utils.image_transform() #list of transformations, set it to None for test set
    ...
    def __getitem__(self, idx):
        ...
        img_file_name = os.path.join(self.root_dir, img_name+".png")
        ...
        if self.transform is not None:
            ...
            if p > 0.5:
                ...
                transformed = transform( image=img, mask=mask_2d)
                img = transformed['image']
                mask_2d = transformed['mask']
